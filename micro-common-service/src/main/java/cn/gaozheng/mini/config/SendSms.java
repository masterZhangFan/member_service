...
public class SendSms {
    ...
    public static void sendMsg(String phone,String code) throws Exception{
        ...
        String appKey = "M16NZPo2yVS97bCdM4L7bZXx5iWU"; //APP_Key
        String appSecret = "xa2Eesf7CXoMB93tG92h4DkV9L4a"; //APP_Secret
        String sender = "8819103038187"; //国内短信签名通道号或国际/港澳台短信通道号
        String templateId = "cdc537339bfb46f38d204fcd23c43abf"; //模板ID

        //条件必填,国内短信关注,当templateId指定的模板类型为通用模板时生效且必填,必须是已审核通过的,与模板类型一致的签名名称
        //国际/港澳台短信不用关注该参数
        String signature = "助消帮"; //签名名称
